...
public class TreeMapEtudiant {
    ...
    public TreeMapEtudiant() {
        ...
        CinTreeMap.put("M605340",new Etudiant("yassine","archid",6666,"M605340"));
    }
...
//13.	Codez une fonction permettant de joindre une map dans une autre.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------------");
        System.out.println("fun trouverEtudiant => "+treeMapEtudiant.chercherExistenceCin(new Etudiant("EL MEHDI ","FATHI",6666,"M605340")));
        System.out.println("-------------------------------------");
        System.out.println("Supperieur Etudiant  "+treeMapEtudiant.Supperieur("cin61"));
        System.out.println("-------------------------------------");
        System.out.println(" Inferieur Etudiant  "+treeMapEtudiant.Inferieur("cin61"));
        System.out.println("-------------------------------------");
        Etudiant E1=new Etudiant("yassine","archid",123, "CIN22");
        System.out.println("add Etudiant "+treeMapEtudiant.ajouterEtudiant(E1));
        treeMapEtudiant.afficherParCin();
        System.out.println("-------------------------------------");
        System.out.println("delete Etudiant "+treeMapEtudiant.supprimerEtudiant1(E1));
        treeMapEtudiant.afficherParCin();
    }
}
